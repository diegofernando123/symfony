...
class FOSUBUserProvider extends BaseClass
{
    ...
    {    
        ...
        if($this->tokenStorage->getToken() && $service == "instagram") {
        	$session = new Session();
        	$profileData = [
				'name' => $service,
			...
			$userInfo = $response->getResourceOwner()->getUserInformation(array(
	        ...
	        $session->set('instagram-profile-data', $profileData);
